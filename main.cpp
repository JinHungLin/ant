...
int main()
{
    ...
    model[0].num_of_tasks = 2;
    model[1].num_of_tasks = 2;
    model[2].num_of_tasks = 2;
    model[3].num_of_tasks = 2;
    model[4].num_of_tasks = 2;
    model[5].num_of_tasks = 2;
    model[6].num_of_tasks = 2;
    model[7].num_of_tasks = 2;
    model[8].num_of_tasks = 2;
    model[9].num_of_tasks = 2;
    ...
    model[0].task_list[1] = &P_task[EyeCheck];

    model[1].task_list[0] = &K_task[BloodCheck];
    model[1].task_list[1] = &P_task[EyeCheck];

    model[2].task_list[0] = &K_task[BloodCheck];
    model[2].task_list[1] = &P_task[EyeCheck];

    model[3].task_list[0] = &K_task[BloodCheck];
    model[3].task_list[1] = &P_task[EyeCheck];

    model[4].task_list[0] = &K_task[BloodCheck];
    model[4].task_list[1] = &P_task[EyeCheck];

    model[5].task_list[0] = &K_task[BloodCheck];
    model[5].task_list[1] = &P_task[EyeCheck];

    model[6].task_list[0] = &K_task[BloodCheck];
    model[6].task_list[1] = &P_task[EyeCheck];

    model[7].task_list[0] = &K_task[BloodCheck];
    model[7].task_list[1] = &P_task[EyeCheck];

    model[8].task_list[0] = &K_task[BloodCheck];
    model[8].task_list[1] = &P_task[EyeCheck];

    model[9].task_list[0] = &K_task[BloodCheck];
    model[9].task_list[1] = &P_task[EyeCheck];
